...
def create_tsv_for_multiple_choice(input_dir, output_file, num_of_choices=5):
	"""
	Function to create a tsv file with random negative samples from corpus. For all component including unconnected
	ones.
...
def main():
	...
	create_tsv_for_relation_classification(input_dir, output)  # create_tsv_for_multiple_choice(input_dir, output)
